 ...
 */
function Adapter__(options) {
    if (!(this instanceof Adapter__)) return new Adapter__(options);
    ...
    function initObjects(cb) {
        ...
        /**
         * Same as {@link Adapter__.setObject}, but for any object.
         *
        ...
        /**
         * Same as {@link Adapter__.extendObject}, but for any object.
         *
         * ID must be specified as a full name with adapter namespace. E.g "hm-rpc.0.ABC98989.1.STATE"
         *
...
util.inherits(Adapter__, EventEmitter);

module.exports = Adapter__;
